...
Participated in the 2nd Cyberthon held by HCI and CSIT. Definitely performed beter than last year. Do check out the writeups by my teammates [@oceankoh](https://oceankoh.github.io/articles/2020-05/Cyberthon-Finals) and [@NyxTo](https://github.com/NyxTo/CTF-Writeups/tree/master/Cyberthon%202020). Also, please check out the HCI geniuses' writeups too! Felt honoured to compete against them.
...
This is definitely <b>NOT</b> the way to solve a data science question. The only reason I did this was because it was a CTF so "exploiting" these kinds of patterns was within the rules of the competition. In a standard data science competition, we are most definitely not allowed to find these kinds of trends, though there should be none to begin with. 
